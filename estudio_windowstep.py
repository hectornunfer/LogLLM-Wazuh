...
if __name__ == '__main__':
    # Lista de valores de window_size y step_size a probar
    window_step_combinations = [(80, 70), (80, 80), (90, 80), (90, 90), (100, 80), (100, 90), (100, 100)]
    ...
    for window_size, step_size in window_step_combinations:
        print(f'Processing window_size={window_size}, step_size={step_size}')
